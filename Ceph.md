...
Откуда ставить репозиторий:<br>
**ceph_origin: repository**<br>
**ceph_repository: community**<br>
**ceph_stable_release: luminous**<br>
**public_network: "172.21.0.0/24"** - сеть, с которой кластер Ceph'a принимает коннекты от клиентов.<br>
**cluster_network: "172.21.0.0/24"** - сеть, в которой компоненты Ceph'a обмениваются между собой информацикй.<br>

Демон для синхронизации времени:<br>
**ntp_service_enabled: true**<br>
**ntp_daemon_type: ntpd**<br>
